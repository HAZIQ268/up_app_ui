...
class LahoreAttractions extends StatefulWidget {
  const LahoreAttractions({super.key});

  @override
  State<LahoreAttractions> createState() => _LahoreAttractionsState();
}

class _LahoreAttractionsState extends State<LahoreAttractions> {
  ...
  Future<void> _fetchAttractions() async {
    try {
      final snapshot = await FirebaseFirestore.instance.collection('Lahore').get();
                      ...
                      ElevatedButton(
                        ...
                        onPressed: () {
                          if (formKey.currentState!.validate()) {
                            ...
                            FirebaseFirestore.instance.collection('Lahore').add(newAttraction)
                              .then((_) {
                                _fetchAttractions();
                                Navigator.pop(context);
                              });
