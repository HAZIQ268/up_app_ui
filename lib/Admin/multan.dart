...
class MultanAttractions extends StatefulWidget {
  const MultanAttractions({super.key});

  @override
  State<MultanAttractions> createState() => _MultanAttractionsState();
}

class _MultanAttractionsState extends State<MultanAttractions> {
  ...
  Future<void> _fetchAttractions() async {
    try {
      final snapshot = await FirebaseFirestore.instance.collection('multan').get();
  ...
  Future<void> _updateAttraction(String docId, Map<String, dynamic> newData) async {
    try {
      await FirebaseFirestore.instance.collection('multan').doc(docId).update(newData);
      _fetchAttractions();
    } catch (e) {
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          focusedBorder: OutlineInputBorder(
            borderRadius: BorderRadius.circular(8),
            borderSide: BorderSide(color: Colors.deepOrange[800]!, width: 2),
          ),
        ),
                      ...
                      ElevatedButton(
                        ...
                        onPressed: () {
                          if (formKey.currentState!.validate()) {
                            ...
                            FirebaseFirestore.instance.collection('multan').add(newAttraction)
                              .then((_) {
                                _fetchAttractions();
                                Navigator.pop(context);
                              });
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: _isLoading
          ? Center(child: CircularProgressIndicator(color: Colors.deepOrange[800]))
          : Column(
              children: [
                Padding(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      prefixIcon: Icon(Icons.search, color: Colors.deepOrange[800]),
                      border: OutlineInputBorder(
                  ...
                  child: Row(
                    children: [
                      ...
                      ChoiceChip(
                        ...
                        selectedColor: Colors.deepOrange[800],
                        onSelected: (selected) {
                          setState(() {
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Wrap(
                                          ...
                                          children: [
                                            Chip(
                                              ...
                                              labelStyle: TextStyle(color: Colors.deepOrange[800]),
                                            ),
                                            Chip(
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            IconButton(
                                              icon: Icon(Icons.edit, color: Colors.deepOrange[800]),
