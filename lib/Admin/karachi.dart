...
class KarachiAttractions extends StatefulWidget {
  const KarachiAttractions({super.key});

  @override
  State<KarachiAttractions> createState() => _KarachiAttractionsState();
}

class _KarachiAttractionsState extends State<KarachiAttractions> {
  ...
  Future<void> _fetchAttractions() async {
    try {
      final snapshot = await FirebaseFirestore.instance.collection('karachi').get();
                      ...
                      ElevatedButton(
                        ...
                        onPressed: () {
                          if (formKey.currentState!.validate()) {
                            ...
                            FirebaseFirestore.instance.collection('karachi').add(newAttraction)
                              .then((_) {
                                _fetchAttractions();
                                Navigator.pop(context);
                              });
